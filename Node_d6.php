...
namespace Drupal\migrate_ib\Plugin\migrate\source;
 ...
 * )
 */
class Node_d6 extends DrupalSqlBase {
  ...
  public function fields() {
    $fields = [
      ...
      'field_sub_heading' => $this->t('The subheading'),
      'field_city' => $this->t('City'),
      'field_article-datef' => $this->t('The date')
    ];
    return $fields;
  }
